...
@Stateless
@WebService(serviceName = "userService", targetNamespace = "http://com.kindustry.api/ws/")
...
public class UserWSService {
	...
	public String equalTest(@WebParam(name = "first") String fstring,
			@WebParam(name = "second") String sstring) {
